...
const TopRatingPage = () => {
    ...
    const fetchMovies = async (page: number) => {
        setLoading(true);
        const url1 = `https://api.themoviedb.org/3/movie/top_rated?api_key=${process.env.NEXT_PUBLIC_TMDB_API_KEY}&page=${page}&language=en-US`;
        const url2 = `https://api.themoviedb.org/3/movie/top_rated?api_key=${process.env.NEXT_PUBLIC_TMDB_API_KEY}&page=${page + 1}&language=en-US`;
        const url3 = `https://api.themoviedb.org/3/movie/top_rated?api_key=${process.env.NEXT_PUBLIC_TMDB_API_KEY}&page=${page + 2}&language=en-US`;
